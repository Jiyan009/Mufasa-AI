...
# (apply_dark_theme, apply_light_theme, render_tiger_mascot, get_weather remain the same)

# 🔁 Inside the main() function (partial edit only):
# Replace this block:
...
# 🔁 With this updated block:
        if prompt := st.chat_input(chat_placeholder):
            ...
            if prompt.lower().startswith("weather in"):
                ...
                response_content = search_with_serpapi(query)  # 🆕 Search integration
            else:
